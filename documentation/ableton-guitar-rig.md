...
> The preamp pedal is a Dynamic effect which means it modifies the volume of an instrument. They usually come at the beginning of the effects chain and are used to boost the volume for solos.
